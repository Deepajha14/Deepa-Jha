  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          ...
          Want to know more about me? Feel free to <a className='resume' href="https://drive.google.com/file/d/1ERM3kdM2vyQPlxnuo4SCPrFJI7lE5NZi/view?usp=sharing" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
